...
After reading the original dataset. Some insights were gathered from the dataset. All the commands and insights can be found in the jupyter notebook (Life_Expectancy.ipynb) and at [insights](df_profile.html). The same notebook was also used to perform data cleaning and Exploratory Data Analysis.
